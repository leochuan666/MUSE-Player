...
from api import home_handler, gcsp_handler, script_handler, music_handler, search_handler
...
# CORS — allow local file:// and any origin for MUSE player
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
app.include_router(search_handler.router)
